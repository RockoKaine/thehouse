...
let userResponses = ()=>{
    ...
    if (document.getElementById('story-intro')) {
        ...
        //this is the var for what comes after player choice
        const afterResponse = `
            <p class="fade-in-text" id="into-the-house">
            <br>
        ...
        switch(responses.storyIntro){
            case 'a':
                movingOn(`Wow you have no sense of adventure, you make it back to you car as the sun's light leaves the sky. You drive back to town, make it home, go to bed and have the sweetest dreams.`, `story-intro-a`)
                break;
            case 'b':
                movingOn(`By the time you get to the front of the mansion the light has left the sky. While the area is dimly lit by lamp post leading down the walk way, it doesn't give off spooky vibes. You approach the door and are greeted by a chill, the door opens, you walk in without much thought.`, `story-intro-a`)
                storyText.innerHTML += afterResponse;
                break;
            case 'c':
                movingOn(`Something isn't right, you are being dragged by your ankles, you know you were asleep for several hours before coming to. You find the nerve to open your eyes, before you have adjusted to the lighting whoever was dragging you drops your feet, and you watch them fade into the shadows back into the woods. You stare after it before you decide it isn't coming back and start to stand up. Other than confusion you feel fine, you were drugged as you were dragged. Also you don't feel any pain, you don't think you were attacked. The doors to the mansion open it is illuminated and welcoming, you can't explain why, but without a second thought you walk into the mansion as though you were an invited guest.`, `story-intro-a`)
                storyText.innerHTML += afterResponse;
                break;
        }
    }
        ...
        Help me ${responses.name} you're my only hope!"`
         ...
         switch(responses.intoTheHouse){
            ...
            case 'c':
                ...
                movingOn(`For some time you cry inconsolably on the ground in the fetal position.
                <br>
                <br>
                What do you do?
                <br>
