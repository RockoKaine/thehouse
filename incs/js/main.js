...
const storyText = document.getElementById('story-text'),
      ...
      playerNameTxt = document.getElementById('player-name'),
...
// txtConnect lets you take parts of the story to combine them
// 
let txtConnect = (...txt)=>{
    return txt.reduce((a,b)=> a + ' ' + b)
}
...
let getPlayerInfo = ()=>{
    ...
    if(playerName === ''){
        ...
        playerNameTxt.innerText = playerName;
        movingOn(`Please tell me your pronoun.`, `get-player-pronoun`);
    } else if (pronoun === '') {
        pronoun = userInput.value;
        ...
        let introTxt = txtConnect(story.storyIntro.txt1,(bonus === 'luck') ? story.storyIntro.luck : story.storyIntro.perc, story.storyIntro.txt2)
